...
if(isset($_SESSION['username'])){
    ...
    if ($_SESSION['warehouse_encreqsup']=="true") {
?>
...
<!--=========================================================================================-->
  ...
  <!----------------------------------->
    ...
    <section class="content-header">
      <h3><i class="fas fa-people-carry"></i>&nbsp;&nbsp; Encode Consumed Supplies</h3>
    </section>
              ...
              <div class="box-body">
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4" id="employeeValidate">
                        ...
                        <input type="text" class="form-control" id="employeeSearch" placeholder="Employee Fullname">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-3" id="dateClaimedValidate">
                        <label class="control-label">Date Claimed *</label>
                        <div class="input-group date">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            <input type="text" class="form-control pull-right" id="dateClaimed" placeholder="mm/dd/yyyy">
                      </div>
                    </div>
                </div>
...
?>
<!--=======================================-->
  <script src=includes/js/consumed_supplies.js></script>
<!--=======================================-->
<?php
  } else{
