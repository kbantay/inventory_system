...
<!--=========================================================================================-->
  ...
  <!----------------------------------->
    ...
    <section class="content-header">
      <h3><i class="fas fa-inbox"></i>&nbsp;&nbsp; Request Supplies</h3>
    </section>
              ...
              <div class="box-body">
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4" id="employeeValidate">
                        ...
                        <input type="text" class="form-control" id="employeeSearch" value="<?php echo $_SESSION['currentUser']; ?>" style="background-color: white;" readonly>
                        <input type="hidden" id="curUserDept" value="<?php echo $_SESSION['department']; ?>">
                    </div>
                    <!-- small space -->
                    ...
                    <div class="col-sm-3" id="dateRequestedValidate">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" id="dateRequested" value="<?php echo date("m/d/Y");?>">
                      </div>
                    </div>
                </div>
...
?>
<!--=======================================-->
  <script src=includes/js/supply_request.js></script>
<!--=======================================-->
<?php
  } else{
