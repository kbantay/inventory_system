...
if(isset($_SESSION['username'])){
  ...
  if ($_SESSION['outlet_suplist']=="true") {
?>
...
<!-- ================================================== MAIN CONTENT - BODY ======================================================== -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <form class="form-horizontal form-label-left input_mask">
                ...
                <div class="form-group col-sm-12">
                  ...
                  <label class="control-label">Stocks in Full</label>
                      <input type="number" class="form-control" id="stocksFull" placeholder="Stocks in full" readonly>
                      <input type="hidden" id="stocksCeiling">
                  </div>
                  <div class="col-sm-6">
        ...
        <div class="modal-footer" id="assetDetailsUpdateBtns">
            <button type="button" class="btn btn-info pull-left" id="editBtn">Edit</button>
            <button type="button" class="btn btn-warning pull-left" id="cancelEditingBtn" style="display: none;">Cancel</button>
            <button type="button" class="btn btn-success pull-right" id="updateBtn" style="display: none;">Update</button>
        </div>
      </div>
    </div>
  </div>
  <!--=========================================================================================-->
    ...
    <section class="content-header">
      <h3><i class="fas fa-clipboard-list"></i>&nbsp;&nbsp; Outlet Supplies Inventory</h3>
    </section>
...
?>
<!--=======================================-->
	<script src=includes/js/outlet_stocks.js></script>
<!--=======================================-->
<?php
  } else{
