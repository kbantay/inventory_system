...
if(isset($_SESSION['username'])){
    ...
    if ($_SESSION['settings_outletemail']=="true") {
?>
 ...
 <!-------------- JS ALERTS ------------->
  ...
  <!----------------------------------->
    ...
    <section class="content-header">
      <h3><i class="far fa-envelope"></i>&nbsp;&nbsp; Outlet Admin Email Notification Setup</h3>
    </section>
      ...
      <div class="box">
        ...
        <div class="col-md-6">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Current Outlet Admin</h3>
                    <input type="hidden" id="page" value="outlet">
                </div>
                <div class="box-body">
