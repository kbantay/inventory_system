...
<!-- ============================================ MAIN CONTENT - BODY ============================================ -->
  ...
  <div class="alert alert-danger alert-dismissible" id="alertError" style="display:none">
   ...
   <div class="alert alert-success alert-dismissible" id="alertBoxSuccess" style="display:none">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
    <i class="icon fa fa-check"></i> Success on updating of role/ permission! 
  </div>
  <!----------------------------------->
    ...
    <section class="content-header">
      <h3><i class="fas fa-user-alt"></i>&nbsp;&nbsp; Edit Role</h3> 
    </section>
        ...
        <div class="row col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href='role_manage' class='btn btn-default editPermission pull-right' title='Back to Role list'><span class='fas fa-clipboard-list'></span> &nbsp;Role List</a>
            </div>
            <!-- form start -->
            <form method="POST" action="includes/handlers/user_registration_handler.php" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="box-footer">
                ...
                <button type="button" name="regsubmit" id="updateRoleBtn" class="btn btn-success pull-right">Update</button>
                </div>
              </div>
              <!-- /.box-footer -->
            </form>
...
<!--=======================================-->
  <script src=includes/js/role_updateRolePerm.js></script>
<!--=======================================-->
